(module
  ...
  (func $treeset_add (type 0) (param i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $treeset_remove (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $treetable_add (type 5) (param i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $rebalance_after_insert (type 6) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
    ...
    i32.add
    global.set $__stack_pointer)
  (func $rotate_left (type 6) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
    ...
    i32.load offset=4
    i32.store offset=12)
  (func $rotate_right (type 6) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $treetable_remove (type 5) (param i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $remove_node (type 6) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $transplant (type 7) (param i32 i32 i32)
    ...
    i32.load offset=12
    i32.store offset=12)
  (func $rebalance_after_delete (type 6) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
